...
sns.barplot(data=df_combined, x='시군구(1)',y='소형',ax=b)
sns.lineplot(data=df_combined,x=np.arange(15),y='총인구',ax=b2)
sns.barplot(data=df_combined, x='시군구(1)',y='중형',ax=c)
sns.lineplot(data=df_combined,x=np.arange(15),y='총인구',ax=c2)
sns.barplot(data=df_combined, x='시군구(1)',y='대형',ax=d)
sns.lineplot(data=df_combined,x=np.arange(15),y='총인구',ax=d2)
